...
{
    public partial class frmChiNguoiThan : Form
    {
        ...
        public void BindingData()
        {
            try
            {
                ...
                string query = "SELECT * FROM QLChiNguoiThan ";
                SqlCommand cmd = new SqlCommand(query, conn);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                ds = new DataSet();
                da.Fill(ds);
        ...
        private void ChiNguoiThan_Load(object sender, EventArgs e)
        {
            btnThem.Enabled = true;
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void dgvMain_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                cbo_tenloaichi.SelectedItem = row.Cells["TenLoaiChi"].Value.ToString();
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Chưa nhập tên loại chi!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cbo_tenloaichi.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("Chưa nhập số tiền!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_sotien.Focus();
                return;
            }
            ...
            if (Status == "Insert")
            {
                ...
                string query = "INSERT INTO QLChiNguoiThan VALUES('" + txt_machi.Text.Trim() + "', N'" + cbo_tenloaichi.SelectedItem.ToString() + "','" + dtp_ngaychi.Value.ToString("MM/dd/yyyy") + "','" + Convert.ToDecimal(txt_sotien.Text.Trim()).ToString() + "',N'" + txt_ghichu.Text.Trim() + "', '"+cbo_id.SelectedValue.ToString()+"')";
                SqlCommand cmd = new SqlCommand(query, conn);
            ...
            else if (Status == "Edit")
            {
                ...
                string query = "UPDATE QLChiNguoiThan SET TenLoaiChi=N'" + cbo_tenloaichi.SelectedItem.ToString() + "', NgayChi= '" + dtp_ngaychi.Value.ToString("MM/dd/yyyy") + "',GhiChu= N'" + txt_ghichu.Text.Trim() + "',SoTien = '" + Convert.ToDecimal(txt_sotien.Text.Trim()).ToString("0,0") +"'  WHERE MaChi= '" + txt_machi.Text.Trim()+"'";
                SqlCommand cmd = new SqlCommand(query, conn);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string query = "DELETE FROM QLChiNguoiThan WHERE MaChi= '" + txt_machi.Text.Trim() + " '";
                    SqlCommand cmd = new SqlCommand(query, conn);
        ...
        private void btnTongChi_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Tổng tiền chi cho người thân là: " + tongChi.ToString());
        }
    }
}
